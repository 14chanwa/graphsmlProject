...
\caption{Influence of $\sigma$ on the reconstruction error (DPP of marginal kernel $K_q$, mean cardinal $2.63$, reconstruction using \eqref{eq:reconstruction:dpp}). The error bars are the $10^\text{th}$ and $90^\text{th}$ percentiles.} \label{fig:Kq:recerror}
\end{figure}
...
\caption{Influence of $\sigma$ on the reconstruction error (DPP of marginal kernel $K_q$, mean cardinal \textbf{a.} $2.65$ and \textbf{b.} $7.92$, reconstruction using \eqref{eq:reconstruction:dpp:unknown:explicit}). The error bars are the $10^\text{th}$ and $90^\text{th}$ percentiles.} \label{fig:Kq:recerror:unknownUk}
\end{figure}


\begin{table}[ht]
  \caption{Max reconstruction error (DPP of marginal kernel $K_q$, mean cardinal $2.65$ and $7.94$, reconstruction using \eqref{eq:reconstruction:dpp:unknown:explicit})}
